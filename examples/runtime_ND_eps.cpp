...
void test_and_print(const std::string &title, Func f, const Poly &poly, const Input &pt, double eps) {
    ...
    std::cout << title << " (eps=" << eps << ")" << std::endl;
...
int main() {
    // =========================================================================
    // Example 1: F: R^2 -> R^2 with runtime-specified error tolerance
    // =========================================================================
    {
        ...
        test_and_print("F:R^2->R^2, Runtime Epsilon", f, poly, In{0.5, -0.2}, epsilon);
    }

    // =========================================================================
    // Example 2: F: R^2 -> R^3 with runtime-specified error tolerance
    // =========================================================================
    {
        using In = std::array<double, 2>;
        ...
        auto poly = poly_eval::make_func_eval(f, epsilon, a, b);
        test_and_print("F:R^2->R^3, Runtime Epsilon", f, poly, In{0.1, 0.8}, epsilon);
    }

    // =========================================================================
    // Example 3: F: R^3 -> R^2 with runtime-specified error tolerance
    // =========================================================================
    {
        ...
        double epsilon = 1e-7;
        auto poly = poly_eval::make_func_eval(f, epsilon, a, b);
        test_and_print("F:R^3->R^2, Runtime Epsilon", f, poly, In{0.3, -0.4, 0.5}, epsilon);
    }
